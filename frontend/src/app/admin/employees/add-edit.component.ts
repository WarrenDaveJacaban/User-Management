        ...
        forkJoin({
            ...
            next: ({ accounts, departments }) => {
                ...
                this.form = this.formBuilder.group({
                    ...
                    // hireDate as string in 'YYYY-MM-DD' format
                    ...
                    this.employeeService.getById(this.id)
                        ...
                        .subscribe(employee => {
                            ...
                            if (employee.hireDate) {
                                ...
                                // Assign as string for form control
                                patchEmployee.hireDate = hireDate.toISOString().substring(0, 10) as any;
                            }
                            
                            this.form.patchValue(patchEmployee);
                            this.form.patchValue(patchEmployee);
                        });
                }
            },
