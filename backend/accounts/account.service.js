...
async function sendVerificationEmail(account, origin) {
    ...
    const baseUrl = origin || 'https://user-management-ik37.vercel.app';
    ...
    if (origin) {
        ...
        verifyUrl = `https://user-management-ik37.vercel.app/account/verify-email?token=${account.verificationToken}`;
    }
...
async function sendAlreadyRegisteredEmail(email, origin) {
    ...
    if (origin) {
        ...
        // Use default Vercel URL
        forgotPasswordUrl = `https://user-management-ik37.vercel.app/account/forgot-password`;
    }
...
async function sendPasswordResetEmail(account, origin) {
    ...
    if (origin) {
        ...
        // Use default Vercel URL
        resetUrl = `https://user-management-ik37.vercel.app/account/reset-password?token=${account.resetToken}`;
    }
